...
V/Oct jack is where the main control voltage is patched.
...
The Slope control will apply a gradual rolloff of the upper harmonics. When it is all the way down the rolloff is 18 decibels per octave. When it is all the way up it’s flat.
